        ...
        <SectionBorder borderTop>
          <SectionContent>
            <LayoutGroup>
              <motion.div
                layout
                className="flex flex-col md:flex-row relative border-gradient rounded-3xl px-6 md:px-10 lg:px-16 py-16 lg:py-24 md:mx-10 lg:mx-20 gap-12"
              >
                <FontAwesomeIcon
                  icon={faQuoteLeft}
                      ...
                      >
                        ...
                        <cite className="not-italic lg:text-right">
                          <Image
                            ...
                            className="rounded-xl sive-28 max-w-none"
                          />
