          ...
          <div className="h-18 lg:h-20 flex items-center justify-between">
            ...
            <div className="hidden lg:flex gap-4">
              {loginItems.map(({ name, href, buttonVariant }) => (
                <a href={href} key={name} className="text-gray-400">
            ...
            <div className="flex items-center lg:hidden">
              <button
                className="size-10 rounded-lg border-2 border-transparent [background:linear-gradient(var(--color-gray-950),var(--color-gray-950))_content-box,conic-gradient(var(--color-violet-400),var(--color-fuchsia-400),var(--color-amber-300),var(--color-teal-300),var(--color-violet-400))_border-box] relative"
